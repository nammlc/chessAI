...
class MenuScreen:
    def __init__(self, screen):
        ...
        self.bg = pygame.transform.scale(pygame.image.load("C:/Users/84961/OneDrive/Tài liệu/G1-chess-ai-master/data/images/th.jpg"), (WIDTH_WINDOW, HEIGHT_WINDOW))
        # theme setting
        ...
        self.menu = pygame_menu.Menu('Chess game - Group 20', 300, 300,
                                     theme=my_theme)
